      ...
      >
        ...
        <div className="relative p-8 pb-6">
          ...
          <div className="text-center">
            <div className="w-16 h-16 bg-spiritual-accent/20 rounded-full flex items-center justify-center mx-auto mb-4">
              <Shield className="w-8 h-8 text-spiritual-accent" />
            </div>
        ...
        <div className="px-8 pb-8">
          <div className="prose prose-lg max-w-none text-spiritual-text-muted">
            ...
            <p className="mb-6">
              We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" className="text-spiritual-accent hover:underline dark:text-spiritual-dark-accent">Privacy Policy Generator</a>.
            </p>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <li><strong>Service</strong> refers to the Website and newsletter registration.</li>
              <li><strong>Service Provider</strong> means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the Service is used.</li>
              <li><strong>Usage Data</strong> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</li>
              <li><strong>Website</strong> refers to fullcircle, accessible from <a href="https://www.joinfullcircle.app" className="text-spiritual-accent hover:underline dark:text-spiritual-dark-accent">https://www.joinfullcircle.app</a></li>
            ...
            <h4 className="text-xl font-semibold text-spiritual-accent mb-3">Types of Data Collected</h4>
            
            <h5 className="text-lg font-semibold text-spiritual-accent mb-2">Personal Data</h5>
            <p className="mb-4">
            ...
            <h5 className="text-lg font-semibold text-spiritual-accent mb-2">Usage Data</h5>
            <p className="mb-4">
            ...
            <h4 className="text-xl font-semibold text-spiritual-accent mb-3">Tracking Technologies and Cookies</h4>
            <p className="mb-4">
            ...
            <h4 className="text-xl font-semibold text-spiritual-accent mb-3">Use of Your Personal Data</h4>
            ...
            <h4 className="text-lg font-semibold text-spiritual-accent mb-3">Business Transactions</h4>
            <p className="mb-4">
              If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
            </p>
            <h4 className="text-lg font-semibold text-spiritual-accent mb-3">Law enforcement</h4>
            <p className="mb-4">
              Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
            </p>
            <h4 className="text-lg font-semibold text-spiritual-accent mb-3">Other legal requirements</h4>
            ...
            <p className="mb-8">
              <strong>By email:</strong> <a href="mailto:hello@joinfullcircle.app" className="text-spiritual-accent hover:underline dark:text-spiritual-dark-accent">hello@joinfullcircle.app</a>
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 rounded-2xl p-6 border border-amber-200 dark:border-amber-700/30 mt-8">
            <div className="flex items-center gap-3 mb-4">
              <Lock className="w-6 h-6 text-spiritual-accent dark:text-spiritual-dark-accent" />
            ...
            <p className="text-center text-spiritual-text-muted dark:text-spiritual-dark-text-muted mb-6">
              We&apos;re committed to protecting your personal information and being transparent about how we use it. If you have any questions or concerns, please don&apos;t hesitate to reach out.
            </p>
            <div className="text-center">
              <button
                onClick={onClose}
