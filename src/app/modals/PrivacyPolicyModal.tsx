        ...
        <div className="px-8 pb-8">
          <div className="prose prose-lg max-w-none text-spiritual-text-muted">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <li><strong>Website</strong> refers to Circle, accessible from <a href="https://www.joinfullcircle.app" className="text-spiritual-accent hover:underline dark:text-spiritual-dark-accent">https://www.joinfullcircle.app</a></li>
