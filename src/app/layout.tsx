...
export const metadata: Metadata = {
  title: "Circle - Sacred Connections",
  description:
  ...
  keywords:
    "spiritual dating, conscious relationships, meditation, yoga, energy healing, sacred connections",
  openGraph: {
    title: "Circle - Sacred Connections",
    description: "Where sacred souls unite",
    images: ["/og-image.jpg"],
  },
};
